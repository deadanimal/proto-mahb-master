...
@Component({
  selector: 'app-getting-there-parking-management',
  templateUrl: './getting-there-parking-management.component.html',
  styleUrls: ['./getting-there-parking-management.component.scss']
})
export class GettingThereParkingManagementComponent implements OnInit {
