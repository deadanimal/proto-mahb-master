...
@Component({
  selector: 'app-ecommerce-hotel-room-booking',
  templateUrl: './ecommerce-hotel-room-booking.component.html',
  styleUrls: ['./ecommerce-hotel-room-booking.component.scss']
})
export class EcommerceHotelRoomBookingComponent implements OnInit {
