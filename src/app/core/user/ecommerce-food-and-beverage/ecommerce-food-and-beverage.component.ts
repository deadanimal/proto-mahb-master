...
@Component({
  selector: 'app-ecommerce-food-and-beverage',
  templateUrl: './ecommerce-food-and-beverage.component.html',
  styleUrls: ['./ecommerce-food-and-beverage.component.scss']
})
export class EcommerceFoodAndBeverageComponent implements OnInit {
